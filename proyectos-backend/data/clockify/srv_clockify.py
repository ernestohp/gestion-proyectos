...
def agregar_tareas_a_proyecto(proyecto_id, tareas):  
    print("Clockify. Iniciando creacion/modificacion de tareas..")  
    #---Tareas actuales en clockfy---
    current_tareas = data_tasks.get_tasks_names_from_project(proyecto_id)
    ...
    if len(tareas_nuevas) > 0:
        for t in tareas_nuevas:
            id_task = data_tasks.add_task_to_project(proyecto_id,t)
