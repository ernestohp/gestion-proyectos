...
const Alertas = ({personas}) => {
    ...
    return (
        ...
        <Tab eventKey="usuarios" title="Usuarios" tabClassName="link3">
            <ListaUsuarios usuariosClockify={usuariosClockify} 
                           usuariosAlerta={usuariosAlerta}
                           onGuardarUsuario={onGuardarUsuario}/>
        </Tab>

        <Tab eventKey="admin" title="Supervisores" tabClassName="link3">
        ...
        <Tab eventKey="parametros" title="Parámetros" tabClassName="link3">
        <Card style={{ width: '50rem' }}>
            <Card.Body>
            {(parametros.length>0) &&
        ...
        <Tab eventKey="ejecutar" title="Ejecutar" tabClassName="link3">
        {/* <Card style={{ width: '50rem' }}>
            <Card.Body> */}
